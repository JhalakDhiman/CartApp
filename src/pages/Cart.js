...
const Cart = () => {
    ...
    return (
        <div className="w-10/12 mx-auto h-[100vh]">
            <div>
                {
                    (cart.length > 0) ?
                        (
                            <div className="flex gap-x-16">
                                ...
                                <div className="w-5/12 flex flex-col justify-between py-10 ">
                                    <div className="mt-10">
                                        ...
                                        <p className="text-[#374151] font-bold text-[20px]">Total Items : <span className="font-semibold">{cart.length}</span></p>
                                    </div>
                                    <div className="flex flex-col gap-y-6">
                                        <p className="font-bold text-[#374151] text-2xl">Total Amount :<span className="font-semibold text-black"> ${amount}</span></p>
